...
If you experience or witness unacceptable behavior, please report it to the project maintainer through GitHub Issues for non-sensitive moderation concerns, or through the security contact path in [SECURITY.md](SECURITY.md) for sensitive reports.

All reports will be reviewed and investigated promptly and fairly. The maintainer will respect the privacy and security of the reporter to the extent possible.
